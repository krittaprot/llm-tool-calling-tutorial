...
# Add this line before making any HTTPS requests
...
def fetch_wikipedia_content(search_query: str, retries=3, delay=1) -> dict:
    """Fetches Wikipedia content for a given search_query with retry logic."""
    ...
    while True:
        ...
        try:
            ...
            print(
                ...
                f"Please ensure:\n"
                f"1. LM Studio server is running at http://localhost:1234/v1 (hostname:port)\n"
